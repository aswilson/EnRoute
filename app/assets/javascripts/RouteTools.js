...
RouteTools.addrStringToPieces = function(addr) {
    ...
    // The way we split added a "" as the first object in stateAndZip
    var wellFormed = stateAndZip.length==3 && (addrPieces.length==4 || addrPieces.length==3);
    if (wellFormed) {
        return {
